...
fig2_plot.py to generate the figure. Requires a JSON file produced by processing
...
pplfile  = '../inputs/big_kc_rnr_seed0.ppl'
simfile  = 'fig2.sim'

json = sc.loadjson(jsonfile)

print(f'Original parameters for {index}:')
entry = json[index]
sc.pp(entry)
pars = entry['pars']
